...
class UnifiedQuizForm(forms.ModelForm):
    """
    Unified form for creating quiz with questions in one page.
    """
    ...
    csv_file = forms.FileField(
        ...
        help_text="Upload a CSV file to prefill quiz questions. You can edit them before creating."
    )

    # Event selection (backed by Quiz.event_name)
    ...
    def __init__(self, *args, **kwargs):
        ...
        # If editing existing quiz, prefill date/time parts from model fields
